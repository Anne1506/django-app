...
urlpatterns = [
    ...
    path('admin/manage-extracurricular/', HodViews.manage_extracurricular, name="manage_extracurricular"),
    path('admin/approve-extracurricular/<int:extracurricular_id>/', HodViews.approve_extracurricular, name="approve_extracurricular"),
    path('admin/reject-extracurricular/<int:extracurricular_id>/', HodViews.reject_extracurricular, name="reject_extracurricular"),
    ...
    path('student/extracurricular/', StudentViews.student_extracurricular, name="student_extracurricular"),
    path('student/extracurricular/add/', StudentViews.student_extracurricular_add, name="student_extracurricular_add"),
